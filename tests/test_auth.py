...
class TestLogin:
    ...
    async def test_login_success(self, client: AsyncClient, test_user):
        ...
        response = await client.post(
            "/v1/auth/login", json={"operator_number": "1234", "pin": "123456"}
        )
    ...
    async def test_login_invalid_operator_number(self, client: AsyncClient):
        ...
        response = await client.post(
            "/v1/auth/login", json={"operator_number": "9999", "pin": "123456"}
        )
    ...
    async def test_login_invalid_pin(self, client: AsyncClient, test_user):
        ...
        response = await client.post(
            "/v1/auth/login",
            json={"operator_number": "1234", "pin": "000000"},  # Valid format but wrong PIN
        )
...
class TestNFCLogin:
    ...
    async def test_nfc_login_success(self, client: AsyncClient, db_session, test_user):
        ...
        response = await client.post("/v1/auth/login-nfc", json={"nfc_tag_id": "NFC123456"})
    ...
    async def test_nfc_login_invalid_tag(self, client: AsyncClient):
        ...
        response = await client.post("/v1/auth/login-nfc", json={"nfc_tag_id": "INVALID_TAG"})
...
class TestRefreshToken:
    ...
    async def test_refresh_token_reuse_prevention(self, client: AsyncClient, test_user):
        ...
        refresh_response = await client.post(
            "/v1/auth/refresh", json={"refresh_token": original_tokens["refresh_token"]}
        )
...
class TestOperatorManagement:
    ...
    async def test_list_operators(self, client: AsyncClient, test_admin_user, admin_auth_headers):
    ...
    async def test_create_operator(self, client: AsyncClient, test_admin_user, admin_auth_headers):
    ...
    async def test_delete_operator(
        ...
        response = await client.delete(
            f"/v1/auth/operators/{user_to_delete.id}", headers=admin_auth_headers
        )
