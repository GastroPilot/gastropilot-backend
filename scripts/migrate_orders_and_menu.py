    ...
    try:
        async with db.engine.begin() as conn:
            ...
            if not orders_exists:
                ...
                """))
                await conn.execute(text("CREATE INDEX idx_orders_restaurant_id ON orders(restaurant_id);"))
                ...
                await conn.execute(text("CREATE INDEX idx_orders_order_number ON orders(order_number);"))
                await conn.execute(text("CREATE INDEX idx_orders_opened_at ON orders(opened_at);"))
                await conn.execute(text("CREATE INDEX idx_orders_created_by_user_id ON orders(created_by_user_id);"))
            ...
            if not menu_categories_exists:
                ...
                """))
                await conn.execute(text("CREATE INDEX idx_menu_categories_restaurant_id ON menu_categories(restaurant_id);"))
            ...
            if not menu_items_exists:
                ...
                """))
                await conn.execute(text("CREATE INDEX idx_menu_items_restaurant_id ON menu_items(restaurant_id);"))
                await conn.execute(text("CREATE INDEX idx_menu_items_category_id ON menu_items(category_id);"))
            ...
            if not order_items_exists:
                ...
                """))
                await conn.execute(text("CREATE INDEX idx_order_items_order_id ON order_items(order_id);"))
                await conn.execute(text("CREATE INDEX idx_order_items_menu_item_id ON order_items(menu_item_id);"))
