...
from app.dependencies import get_session, get_current_user, require_mitarbeiter_role
from app.database.models import (
    User, Restaurant, Table, Reservation, Order, OrderItem,
)
from app.services.ai_service import ai_service, TableSuggestion
...
class SuggestTableRequest(BaseModel):
    ...
    context_hint: Optional[str] = None  # z.B. Gästename oder Tischnummer
...
async def suggest_table(
    ...
    logger.info(f"AI suggest-table for restaurant {restaurant_id}: "
