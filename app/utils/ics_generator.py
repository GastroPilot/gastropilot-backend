...
def generate_ics_file(
    ...
    if organizer_email:
        ...
        organizer_line = f"ORGANIZER;CN={escape_ics_text(organizer_name)}:mailto:noreply@gastropilot.org"
        lines.append(organizer_line)
    ...
    if attendee_email:
        ...
        # Fallback: Verwende Platzhalter-E-Mail wenn nur Name vorhanden
        attendee_line = f"ATTENDEE;CN={escape_ics_text(attendee_name)}:mailto:noreply@gastropilot.org;RSVP=TRUE"
        lines.append(attendee_line)
